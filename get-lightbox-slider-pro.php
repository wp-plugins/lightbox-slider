...
font-size: 36px;
padding-top: 30px;
padding-bottom: 10px;">Lightbox Slider Pro Screenshots</h2>
<h6 style="
font-size: 22px;
padding-top: 10px;
padding-bottom: 10px;">Get All Lighbox in Lightbox Slider Pro only in 12$</h6>
    </div>
	<!-- SLIDER-INTRO-->
				<!--===============================================================-->
...
background: #f7f7f7;padding:10px" class="img-responsive" src="http://weblizar.com/wp-content/themes/home-theme/images/lightbox/prettyphoto.jpg" alt=""/>
				...
				<div class="col-sm-4 col-xs-4">
					<h2 style="font-weight: bold;font-size: 26px;padding-top: 20px;padding-bottom: 20px; text-align:center">Window Box</h2>
					<img style="border: 1px solid #e3e3e3;
background: #f7f7f7;padding:10px" class="img-responsive" src="http://weblizar.com/wp-content/themes/home-theme/images/lightbox/window.png" alt=""/>
				</div>
				<div class="col-sm-4 col-xs-4">
					<h2 style="font-weight: bold;font-size: 26px;padding-top: 20px;padding-bottom: 20px; text-align:center">Smooth Box</h2>
					<img style="border: 1px solid #e3e3e3;
background: #f7f7f7;padding:10px" class="img-responsive" src="http://weblizar.com/wp-content/themes/home-theme/images/lightbox/smooth.png" alt=""/>
				</div>
				<div class="col-sm-4 col-xs-4">
...
background: #f7f7f7;padding:10px" class="img-responsive" src="http://weblizar.com/wp-content/themes/home-theme/images/lightbox/swipebox.jpg" alt=""/>
				...
				<div class="col-sm-4 col-xs-4">
					<h2 style="font-weight: bold;font-size: 26px;padding-top: 20px;padding-bottom: 20px; text-align:center">Ion Box</h2>
					<img style="border: 1px solid #e3e3e3;
background: #f7f7f7;padding:10px" class="img-responsive" src="http://weblizar.com/wp-content/themes/home-theme/images/lightbox/ion.jpg" alt=""/>
				</div>
				<div class="col-sm-4 col-xs-4">
					<h2 style="font-weight: bold;font-size: 26px;padding-top: 20px;padding-bottom: 20px; text-align:center">Fancy Box</h2>
					<img style="border: 1px solid #e3e3e3;
background: #f7f7f7;padding:10px" class="img-responsive" src="http://weblizar.com/wp-content/themes/home-theme/images/lightbox/fancy.jpg" alt=""/>
				</div>
	...
	<div class="col-md-4">
		<div class=" plan ap">
			...
			<ul>
				...
				<li class="plan-feature">Caption Font Style</li>
